document.addEventListener("DOMContentLoaded", function () {
  if (document.getElementById("simulador-widget")) return;

  const container = document.createElement("div");
  container.id = "simulador-widget";
  container.innerHTML = `
    <style>
  ...
  const target = document.getElementById("simulador-container");
  ...
  window.selectTab = function (button, type) {
